...
Current contracts are documented in [pipeline](docs/pipeline.md),
[contributions](docs/contributions.md), and [diagnostics](docs/diagnostics.md).
The Layers tab edits an ordered scene stack or sparse selected-object overrides;
Paper remains scene-owned. Normal, Multiply and Screen execute in WGPU. Constant
layer colours are supported for fill and stroke layers.
...
Playback and FPS stay pinned around seven tabs: appearance, layers, object, scene, camera,
