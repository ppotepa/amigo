...
use amigo_scene::{
    text_2d_plugin_scene_command, SceneCommand, SceneEvent, SceneEventQueue, SceneService,
    Text2dSceneCommand,
};
...
fn can_handle_text_scene_command_returns_true_for_text_command() {
    let command = SceneCommand::plugin(text_2d_plugin_scene_command(Text2dSceneCommand::new(
        "playground-2d",
        "playground-2d-label",
        "AMIGO 2D",
        AssetKey::new("playground-2d/fonts/debug-ui"),
