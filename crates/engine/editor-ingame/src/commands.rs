    ...
    fn descriptors(&self) -> Vec<ConsoleCommandDescriptor> {
        vec![
            ...
            ConsoleCommandDescriptor {
                ...
                aliases: &[],
                category: "editor",
                help: "Show current runtime opacity for key preview layers.",
            ...
            ConsoleCommandDescriptor {
                ...
                aliases: &[],
                category: "editor",
                help: "Debug-only: force common preview layers visible.",
            ...
            ConsoleCommandDescriptor {
                ...
                examples: &[
                    "editor.select mods/playground-2d/scenes/screen-space-preview/scene.yml#/entities/0",
                ],
                dev_only: true,
            },
            ConsoleCommandDescriptor {
