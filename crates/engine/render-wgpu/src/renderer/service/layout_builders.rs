pub(crate) struct WgpuCommonBindGroupLayouts {
    pub(crate) texture: wgpu::BindGroupLayout,
    pub(crate) camera_visual_source: wgpu::BindGroupLayout,
    pub(crate) focus_blur_texture: wgpu::BindGroupLayout,
    pub(crate) shutter_blur_texture: wgpu::BindGroupLayout,
    pub(crate) wet_reflections_texture: wgpu::BindGroupLayout,
    pub(crate) wet_reflections_uniform: wgpu::BindGroupLayout,
}

pub(crate) fn create_common_bind_group_layouts(
    device: &wgpu::Device,
    ...
    let camera_visual_source = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
    ...
    WgpuCommonBindGroupLayouts {
        texture,
        camera_visual_source,
        focus_blur_texture,
        shutter_blur_texture,
        wet_reflections_texture,
        wet_reflections_uniform,
    }
}
