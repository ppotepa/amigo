...
pub type ScenePluginComponentDescriptor =
    amigo_plugin_api::PluginSceneComponentDescriptor;
...
pub struct ScenePluginDescriptorRegistry {
    descriptors:
        BTreeMap<ScenePluginComponentId, ScenePluginComponentDescriptor>,
}
...
impl ScenePluginDescriptorRegistry {
    ...
    pub fn iter(
        &self,
    ) -> impl Iterator<Item = &ScenePluginComponentDescriptor> {
    ...
    pub fn invalid_descriptors(
        &self,
    ) -> Vec<&ScenePluginComponentDescriptor> {
        self.descriptors
            .values()
    ...
    pub fn register_provider(
        &mut self,
        provider: &impl ScenePluginDescriptorProvider,
    ) {
