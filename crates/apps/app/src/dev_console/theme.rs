...
/// not in overlay.rs.
#[derive(Debug, Clone)]
pub(crate) struct DevConsoleTheme {
    pub(crate) viewport: DevConsoleViewportTheme,
    pub(crate) layout: DevConsoleLayoutTheme,
    pub(crate) font: DevConsoleFontTheme,
    pub(crate) colors: DevConsoleColorTheme,
    pub(crate) levels: DevConsoleLevelTheme,
}

#[derive(Debug, Clone, Copy)]
pub(crate) struct DevConsoleViewportTheme {
    pub(crate) fallback_width: f32,
    pub(crate) fallback_height: f32,
}

#[derive(Debug, Clone, Copy)]
pub(crate) struct DevConsoleLayoutTheme {
    pub(crate) margin: f32,
    pub(crate) min_panel_width: f32,
    pub(crate) max_panel_width: f32,
    pub(crate) min_panel_height: f32,
    pub(crate) max_panel_height: f32,
    pub(crate) panel_height_fraction: f32,
    pub(crate) panel_padding: f32,
    pub(crate) header_height: f32,
    pub(crate) input_height: f32,
    pub(crate) output_gap: f32,
    pub(crate) line_height: f32,
    pub(crate) scrollbar_width: f32,
    pub(crate) scrollbar_gap: f32,
    pub(crate) scrollbar_min_thumb_height: f32,
    pub(crate) scrollbar_min_visible_ratio: f32,
    pub(crate) border_width: f32,
    pub(crate) border_radius: f32,
}

#[derive(Debug, Clone)]
pub(crate) struct DevConsoleFontTheme {
    pub(crate) asset: Option<AssetKey>,
    pub(crate) header_size: f32,
    pub(crate) output_size: f32,
    pub(crate) input_size: f32,
}

#[derive(Debug, Clone, Copy)]
pub(crate) struct DevConsoleColorTheme {
    pub(crate) backdrop: ColorRgba,
    pub(crate) panel_background: ColorRgba,
    pub(crate) panel_border: ColorRgba,
    pub(crate) header_text: ColorRgba,
    pub(crate) input_text: ColorRgba,
    pub(crate) scrollbar_track: ColorRgba,
    pub(crate) scrollbar_thumb: ColorRgba,
}

#[derive(Debug, Clone, Copy)]
pub(crate) struct DevConsoleLevelTheme {
    pub(crate) info: ColorRgba,
    pub(crate) success: ColorRgba,
    pub(crate) warning: ColorRgba,
    pub(crate) error: ColorRgba,
    pub(crate) command: ColorRgba,
}

impl DevConsoleTheme {
    pub(crate) fn level_color(&self, level: DevConsoleOutputLevel) -> ColorRgba {
        match level {
    ...
    pub(crate) fn text_font(&self) -> Option<AssetKey> {
