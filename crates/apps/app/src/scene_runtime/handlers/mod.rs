...
pub(super) use composition2d::SceneComposition2dCommandHandler;
pub(super) use event_pipeline::SceneEventPipelineCommandHandler;
pub(super) use input_actions::SceneInputActionsCommandHandler;
pub(super) use layered_image2d::SceneLayeredImage2dCommandHandler;
pub(super) use lifecycle::SceneLifecycleCommandHandler;
pub(super) use lighting2d::SceneLighting2dCommandHandler;
...
pub(super) use post_fx::ScenePostFxCommandHandler;
...
pub(super) fn register_builtin_scene_command_handlers(registry: &mut SceneCommandHandlerRegistry) {
    ...
    register_scene_command_handler(registry, SceneLayeredImage2dCommandHandler);
    register_scene_command_handler(registry, SceneComposition2dCommandHandler);
    register_scene_command_handler(registry, SceneLighting2dCommandHandler);
    ...
    register_scene_command_handler(registry, ScenePostFxCommandHandler);
