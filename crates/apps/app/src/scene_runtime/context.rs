...
pub(super) struct AppSceneCommandContext<'a> {
    ...
    pub(super) render_layer2d_scene_service: &'a amigo_2d_composition::RenderLayer2dSceneService,
    pub(super) light_route2d_scene_service: &'a amigo_2d_composition::LightRoute2dSceneService,
    pub(super) global_light2d_scene_service: &'a amigo_2d_lighting::GlobalLight2dSceneService,
    pub(super) lightmap2d_scene_service: &'a amigo_2d_lighting::LightMap2dSceneService,
    pub(super) light_group2d_scene_service: &'a amigo_2d_lighting::LightGroup2dSceneService,
